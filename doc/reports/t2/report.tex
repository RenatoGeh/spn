...
details on this subject in this paper. For more information see~\cite{poon-domingos}.
...
\begin{itemize}
  ...
  \item \textbf{Uncertainty and Probabilistic Reasoning}
    \begin{description}
      \item[Description:] inference, Baye's rule, Bayesian networks, inference on Bayesian networks
      \item[Bibliographical notes:]\ \
        \begin{description}
          ...
          \item[Bayesian networks:] Modeling and Reasoning with Bayesian Networks~\cite{bayes-net-darwiche}.
        \end{description}
    \end{description}
